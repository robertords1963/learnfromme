...
export default function LearnFromMe() {
  ...
  const [experiences, setExperiences] = useState([
    ...
    {
      id: 346,
      problem: 'Persistent bad breath despite good oral hygiene routine',
      problemCategory: 'Health',
      solution: 'Dentist found and removed hidden tonsil stones causing odor',
      result: 'Breath fresh permanently, confidence in social situations restored',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 176,
    ...
    {
      id: 347,
      problem: 'Car check engine light illuminated for three months',
      problemCategory: 'Other',
      solution: 'Bought OBD2 scanner online, diagnosed loose gas cap issue',
      result: 'Light cleared, saved hundreds in diagnostic fees',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 142,
    ...
    {
      id: 348,
      problem: 'Child bed-wetting at age 8 causing emotional distress',
      problemCategory: 'Family',
      solution: 'Pediatrician recommended bedwetting alarm, used consistently',
      result: 'Achieved dry nights within 6 weeks, child confidence improved',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 203,
    ...
    {
      id: 349,
      problem: 'Severe social anxiety preventing job interviews',
      problemCategory: 'Well-being',
      solution: 'Started cognitive behavioral therapy with exposure exercises',
      result: 'Successfully completed interviews, got job, anxiety manageable',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 350,
      problem: 'Washing machine flooding laundry room during cycles',
      problemCategory: 'Other',
      solution: 'Replaced worn rubber door seal gasket',
      result: 'No more leaks, machine working perfectly',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 156,
    ...
    {
      id: 351,
      problem: 'Credit score stuck at 620 despite timely payments',
      problemCategory: 'Finance',
      solution: 'Paid off collections, became authorized user on established account',
      result: 'Score increased to 720 within 8 months',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 194,
    ...
    {
      id: 352,
      problem: 'Dog eating own feces despite quality diet',
      problemCategory: 'Other',
      solution: 'Vet recommended digestive enzyme supplement',
      result: 'Behavior stopped completely within 2 weeks',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 138,
    ...
    {
      id: 353,
      problem: 'Severe menstrual cramps debilitating each month',
      problemCategory: 'Health',
      solution: 'Gynecologist prescribed birth control for symptom management',
      result: 'Pain reduced 90%, quality of life dramatically improved',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 354,
      problem: 'Bluetooth speaker refusing to connect to phone',
      problemCategory: 'Other',
      solution: 'Unpaired device completely, updated firmware, re-paired',
      result: 'Connection stable, audio quality excellent',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.4,
      totalRatings: 97,
    ...
    {
      id: 355,
      problem: 'Teen daughter self-harming, discovered cuts on arms',
      problemCategory: 'Family',
      solution: 'Got immediate mental health evaluation and weekly therapy',
      result: 'Self-harm stopped, underlying depression being actively treated',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 224,
    ...
    {
      id: 356,
      problem: 'Bathtub draining extremely slowly after showers',
      problemCategory: 'Other',
      solution: 'Used zip-it tool to remove hair clog',
      result: 'Drains perfectly, simple inexpensive fix',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 118,
    ...
    {
      id: 357,
      problem: 'Chronic shoulder pain limiting daily movement',
      problemCategory: 'Health',
      solution: 'Physical therapist diagnosed frozen shoulder, prescribed exercises',
      result: 'Full range of motion restored in 4 months',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '41-60',
    ...
    {
      id: 358,
      problem: 'Indoor plants attracting swarms of fungus gnats',
      problemCategory: 'Other',
      solution: 'Let soil dry completely between watering, added sand layer',
      result: 'Gnats eliminated, plants actually healthier',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 143,
    ...
    {
      id: 359,
      problem: 'Infant reflux causing constant spit-up and discomfort',
      problemCategory: 'Family',
      solution: 'Pediatrician suggested smaller frequent feedings, keep upright',
      result: 'Reflux dramatically reduced, baby comfortable and happy',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 360,
      problem: 'Laptop overheating and fan extremely loud',
      problemCategory: 'Other',
      solution: 'Opened case, cleaned accumulated dust from vents',
      result: 'Quiet operation restored, temperature normal',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 159,
    ...
    {
      id: 361,
      problem: 'High interest credit card charges accumulating',
      problemCategory: 'Finance',
      solution: 'Called card company, negotiated lower APR successfully',
      result: 'Interest rate cut in half, paying down faster',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 134,
    ...
    {
      id: 362,
      problem: 'Eyebrow hair loss creating noticeable bald patches',
      problemCategory: 'Health',
      solution: 'Dermatologist diagnosed thyroid issue, started medication',
      result: 'Eyebrows grew back fully within 6 months',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 363,
      problem: 'Fence gate sagging badly and difficult to open',
      problemCategory: 'Other',
      solution: 'Installed support wheel at bottom, rehung hinges properly',
      result: 'Gate swings smoothly, properly aligned',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 121,
    ...
    {
      id: 364,
      problem: 'Performance reviews consistently mediocre at work',
      problemCategory: 'Work',
      solution: 'Asked for specific feedback, created improvement plan with manager',
      result: 'Next review excellent, received raise',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 163,
    ...
    {
      id: 365,
      problem: 'Toddler tantrums increasing in frequency and intensity',
      problemCategory: 'Family',
      solution: 'Read parenting books, implemented consistent boundaries',
      result: 'Tantrums reduced by 80%, behavior improved',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 148,
    ...
    {
      id: 366,
      problem: 'Kitchen cabinet doors not closing flush',
      problemCategory: 'Other',
      solution: 'Adjusted all hinges, installed soft-close mechanisms',
      result: 'All doors close perfectly, look professional',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.4,
      totalRatings: 103,
    ...
    {
      id: 367,
      problem: 'Chronic sinusitis causing severe facial pain',
      problemCategory: 'Health',
      solution: 'ENT prescribed extended antibiotic course, daily sinus rinse',
      result: 'Infection cleared, no recurrence in over a year',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 182,
    ...
    {
      id: 368,
      problem: 'Weeds growing through driveway cracks',
      problemCategory: 'Other',
      solution: 'Applied crack filler, sealed entire driveway surface',
      result: 'Weeds gone, driveway looks new',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 127,
    ...
    {
      id: 369,
      problem: 'Wedding debt overwhelming newlywed couple',
      problemCategory: 'Finance',
      solution: 'Created strict budget, both got temporary second jobs',
      result: 'Debt paid off in 18 months, marriage stronger',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 169,
    ...
    {
      id: 370,
      problem: 'Bird nesting inside clothes dryer vent',
      problemCategory: 'Other',
      solution: 'Removed nest safely, installed vent cover with flap',
      result: 'Vent clear, birds cannot return',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 139,
    ...
    {
      id: 371,
      problem: 'Vitamin D deficiency causing severe fatigue',
      problemCategory: 'Health',
      solution: 'Doctor prescribed high-dose supplement, increased sun exposure',
      result: 'Energy returned within weeks, mood improved significantly',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 372,
      problem: 'Roommate conflict escalating over cleaning standards',
      problemCategory: 'Relationship',
      solution: 'Created written cleaning schedule with rotating tasks',
      result: 'Apartment consistently clean, conflict eliminated',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 124,
    ...
    {
      id: 373,
      problem: 'Deck boards rotting and becoming unsafe',
      problemCategory: 'Other',
      solution: 'Replaced damaged boards with composite decking material',
      result: 'Deck safe and virtually maintenance-free',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 157,
    ...
    {
      id: 374,
      problem: 'Child terrified of water, refusing swimming lessons',
      problemCategory: 'Family',
      solution: 'Found instructor specializing in anxious children',
      result: 'Child now loves swimming, fear completely overcome',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 206,
    ...
    {
      id: 375,
      problem: 'Basement flooding during every heavy rainstorm',
      problemCategory: 'Other',
      solution: 'Installed French drain system and sump pump',
      result: 'Basement stays dry even in worst storms',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 213,
    ...
    {
      id: 376,
      problem: 'Recurring urinary tract infections monthly',
      problemCategory: 'Health',
      solution: 'Urologist found anatomical issue, performed minor surgery',
      result: 'No UTIs in 2 years since procedure',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 377,
      problem: 'Car making grinding noise when braking',
      problemCategory: 'Other',
      solution: 'Mechanic replaced worn brake pads and resurfaced rotors',
      result: 'Brakes quiet and responsive, safe operation restored',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 146,
    ...
    {
      id: 378,
      problem: 'Teenager refusing to do any household chores',
      problemCategory: 'Family',
      solution: 'Implemented allowance system tied to completed tasks',
      result: 'Teen completing chores regularly to earn money',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 132,
    ...
    {
      id: 379,
      problem: 'Excessive sweating causing social embarrassment',
      problemCategory: 'Health',
      solution: 'Dermatologist prescribed clinical strength antiperspirant',
      result: 'Sweating reduced 80%, confidence fully restored',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 380,
      problem: 'Light bulbs burning out constantly throughout house',
      problemCategory: 'Other',
      solution: 'Electrician found voltage fluctuation, installed whole-house surge protector',
      result: 'Bulbs lasting normal lifespan, problem solved',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 184,
    ...
    {
      id: 381,
      problem: 'Investment portfolio underperforming market average',
      problemCategory: 'Finance',
      solution: 'Hired fee-only financial advisor, rebalanced asset allocation',
      result: 'Returns improved significantly, now beating market',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 153,
    ...
    {
      id: 382,
      problem: 'Dog barking aggressively at mail carrier daily',
      problemCategory: 'Other',
      solution: 'Worked with professional trainer on desensitization protocol',
      result: 'Dog now calm during mail delivery',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 166,
    ...
    {
      id: 383,
      problem: 'Gum recession exposing sensitive tooth roots',
      problemCategory: 'Health',
      solution: 'Periodontist performed gum graft surgical procedure',
      result: 'Gums healthy and covered, sensitivity eliminated',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '41-60',
    ...
    {
      id: 384,
      problem: 'Dishwasher leaving cloudy film on all dishes',
      problemCategory: 'Other',
      solution: 'Ran dishwasher cleaner cycle, switched to powder detergent',
      result: 'Dishes sparkling clean with no residue',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 128,
    ...
    {
      id: 385,
      problem: 'Passed over for promotion three consecutive times',
      problemCategory: 'Work',
      solution: 'Had honest conversation with boss about career development',
      result: 'Given clear promotion timeline and development goals',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 142,
    ...
    {
      id: 386,
      problem: 'One-year-old baby not sleeping through night',
      problemCategory: 'Family',
      solution: 'Implemented gentle sleep training method consistently',
      result: 'Baby sleeping 11 hours nightly within one week',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 197,
    ...
    {
      id: 387,
      problem: 'Asphalt driveway developing extensive cracks',
      problemCategory: 'Other',
      solution: 'Filled all cracks properly, applied protective seal coat',
      result: 'Driveway protected and looks refreshed',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 137,
    ...
    {
      id: 388,
      problem: 'Knee swelling and pain after any exercise',
      problemCategory: 'Health',
      solution: 'Orthopedist prescribed specific strengthening exercises',
      result: 'Swelling resolved completely, knee stable',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 389,
      problem: 'Ant invasion returning every spring season',
      problemCategory: 'Other',
      solution: 'Located colony entry point, used targeted bait system',
      result: 'Ant problem permanently solved',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 189,
    ...
    {
      id: 390,
      problem: 'Tax refund significantly lower than expected',
      problemCategory: 'Finance',
      solution: 'Adjusted W-4 withholding amounts for following year',
      result: 'Refund amount appropriate, no more surprises',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.4,
      totalRatings: 116,
    ...
    {
      id: 391,
      problem: 'Coffee maker brewing increasingly weak coffee',
      problemCategory: 'Other',
      solution: 'Descaled machine thoroughly with vinegar solution',
      result: 'Coffee strong and flavorful like new',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 123,
    ...
    {
      id: 392,
      problem: 'Scalp psoriasis causing embarrassing flaking',
      problemCategory: 'Health',
      solution: 'Dermatologist prescribed medicated shampoo and topical cream',
      result: 'Scalp completely clear, no more flaking',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 393,
      problem: 'Fence staining project seemed overwhelming',
      problemCategory: 'Other',
      solution: 'Rented professional paint sprayer equipment',
      result: 'Entire fence completed in one weekend, professional results',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 141,
    ...
    {
      id: 394,
      problem: 'Child struggling significantly with reading comprehension',
      problemCategory: 'Education',
      solution: 'School evaluation revealed dyslexia, accommodations implemented',
      result: 'Reading level steadily improving, confidence growing',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 208,
    ...
    {
      id: 395,
      problem: 'Computer constantly running out of storage space',
      problemCategory: 'Other',
      solution: 'Added large external SSD drive, moved files',
      result: 'Plenty of space, computer runs faster',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 167,
    ...
    {
      id: 396,
      problem: 'Morning anxiety attacks before leaving for work',
      problemCategory: 'Well-being',
      solution: 'Therapist taught grounding techniques, started medication',
      result: 'Attacks rare now, mornings peaceful',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 186,
    ...
    {
      id: 397,
      problem: 'Neighbor tree branches scraping and damaging roof',
      problemCategory: 'Other',
      solution: 'Hired certified arborist for professional trimming',
      result: 'Roof protected, maintained good neighbor relations',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 134,
    ...
    {
      id: 398,
      problem: 'Chronic constipation despite adequate fiber intake',
      problemCategory: 'Health',
      solution: 'Gastroenterologist diagnosed pelvic floor dysfunction, referred to specialist',
      result: 'Bowel movements regular, quality of life improved',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 399,
      problem: 'Bluetooth headphones battery draining in one hour',
      problemCategory: 'Other',
      solution: 'Replaced battery in repairable headphone model',
      result: 'Battery life restored to 8 hours like new',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 126,
    ...
    {
      id: 400,
      problem: 'Teen expressing desire to drop out of college',
      problemCategory: 'Education',
      solution: 'Had non-judgmental conversation about reasons and explored alternatives',
      result: 'Teen took semester off to reset, returned motivated',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 149,
    ...
    {
      id: 401,
      problem: 'Persistent ringing in ears affecting concentration',
      problemCategory: 'Health',
      solution: 'Tried sound masking therapy apps and white noise',
      result: 'Tinnitus volume unchanged, still equally bothersome',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 163,
    ...
    {
      id: 402,
      problem: 'Lower back pain from office chair posture',
      problemCategory: 'Health',
      solution: 'Tried various lumbar support cushions',
      result: 'Pain persisted at same level with all products',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 148,
    ...
    {
      id: 403,
      problem: 'Spouse spending excessive time on social media',
      problemCategory: 'Relationship',
      solution: 'Made passive-aggressive comments about phone use',
      result: 'Spouse became defensive, phone use unchanged, tension increased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 177,
    ...
    {
      id: 404,
      problem: 'Dandruff persisting despite specialized shampoos',
      problemCategory: 'Health',
      solution: 'Tried five different dandruff shampoo brands',
      result: 'Flaking continued with all products',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 156,
    ...
    {
      id: 405,
      problem: 'Teen lying about whereabouts and activities',
      problemCategory: 'Family',
      solution: 'Installed tracking software on phone secretly',
      result: 'Trust destroyed when discovered, lying increased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
      totalRatings: 191,
    ...
    {
      id: 406,
      problem: 'Persistent dry cough lingering for weeks',
      problemCategory: 'Health',
      solution: 'Took over-the-counter cough suppressants',
      result: 'Cough frequency unchanged despite medication',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 142,
    ...
    {
      id: 407,
      problem: 'Child refusing to eat healthy foods',
      problemCategory: 'Family',
      solution: 'Only provided preferred junk foods to avoid conflict',
      result: 'Child became more selective, diet worse',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.4,
      totalRatings: 184,
    ...
    {
      id: 408,
      problem: 'Chronic heartburn after evening meals',
      problemCategory: 'Health',
      solution: 'Eliminated acidic foods from diet',
      result: 'Heartburn occurred at same frequency',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 167,
    ...
    {
      id: 409,
      problem: 'Partner critical of everything I do',
      problemCategory: 'Relationship',
      solution: 'Started criticizing them equally to show how it feels',
      result: 'Criticism escalated both ways, relationship toxic',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 198,
    ...
    {
      id: 410,
      problem: 'Restless leg syndrome preventing sleep',
      problemCategory: 'Health',
      solution: 'Tried magnesium supplements nightly',
      result: 'Symptoms continued unchanged',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 151,
    ...
    {
      id: 411,
      problem: 'Friend constantly canceling plans last minute',
      problemCategory: 'Relationship',
      solution: 'Confronted them aggressively about disrespect',
      result: 'Friend ended friendship completely',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.3,
      totalRatings: 169,
    ...
    {
      id: 412,
      problem: 'Frequent headaches every afternoon at work',
      problemCategory: 'Health',
      solution: 'Increased caffeine and water intake',
      result: 'Headaches unchanged despite changes',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 158,
    ...
    {
      id: 413,
      problem: 'Teenager withdrawn and isolating in room',
      problemCategory: 'Family',
      solution: 'Removed bedroom door as punishment',
      result: 'Teen became more secretive and resentful',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
      totalRatings: 187,
    ...
    {
      id: 414,
      problem: 'Dry skin despite regular moisturizer use',
      problemCategory: 'Health',
      solution: 'Switched to expensive luxury moisturizer brand',
      result: 'Skin dryness unchanged with premium product',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 144,
    ...
    {
      id: 415,
      problem: 'Coworker taking credit for my work',
      problemCategory: 'Work',
      solution: 'Sent angry email to entire department',
      result: 'Viewed as unprofessional, situation worsened',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.4,
      totalRatings: 176,
    ...
    {
      id: 416,
      problem: 'Persistent athlete foot despite treatment',
      problemCategory: 'Health',
      solution: 'Continued same antifungal cream for months',
      result: 'Infection unchanged after extended use',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.0,
      totalRatings: 139,
    ...
    {
      id: 417,
      problem: 'Mother-in-law interfering with parenting',
      problemCategory: 'Family',
      solution: 'Yelled at her about boundaries',
      result: 'Family gatherings became hostile, relationship damaged',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 192,
    ...
    {
      id: 418,
      problem: 'Chronic fatigue despite adequate sleep',
      problemCategory: 'Health',
      solution: 'Tried various energy supplement pills',
      result: 'Energy levels remained unchanged',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 154,
    ...
    {
      id: 419,
      problem: 'Sibling borrowing money and not repaying',
      problemCategory: 'Family',
      solution: 'Lent more money hoping they would pay everything back',
      result: 'Now owed even more, still no repayment',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.3,
      totalRatings: 171,
    ...
    {
      id: 420,
      problem: 'Vertigo episodes causing dizziness',
      problemCategory: 'Health',
      solution: 'Tried ginger supplements and acupressure',
      result: 'Episodes continued at same frequency',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 165,
    ...
    {
      id: 421,
      problem: 'Partner gained weight affecting attraction',
      problemCategory: 'Relationship',
      solution: 'Made comments about their appearance',
      result: 'Partner hurt deeply, intimacy decreased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 203,
    ...
    {
      id: 422,
      problem: 'Persistent acne on chin and jawline',
      problemCategory: 'Health',
      solution: 'Tried multiple different face wash products',
      result: 'Acne severity unchanged with all products',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 149,
    ...
    {
      id: 423,
      problem: 'Son failing multiple classes at school',
      problemCategory: 'Education',
      solution: 'Grounded indefinitely and took away all privileges',
      result: 'Grades declined further, depression developed',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 188,
    ...
    },
    {
      ...
      problemCategory: 'Health',
      solution: 'Wore extra layers and thicker socks',
      result: 'Still cold despite additional clothing',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.0,
      totalRatings: 141,
    ...
    {
      id: 425,
      problem: 'Ex-partner texting constantly after breakup',
      problemCategory: 'Relationship',
      solution: 'Responded to messages trying to stay friends',
      result: 'Ex became more attached, harassment intensified',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
    ...
    },
    {
      ...
      problem: 'Recurring canker sores in mouth',
      problemCategory: 'Health',
      solution: 'Used various over-the-counter mouth rinses',
      result: 'Sores appeared at same frequency',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 157,
    ...
    {
      id: 427,
      problem: 'Daughter dating someone I disapprove of',
      problemCategory: 'Family',
      solution: 'Forbade relationship and grounded her',
      result: 'Daughter became secretive, relationship with me damaged',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 196,
    ...
    {
      id: 428,
      problem: 'Persistent hiccups lasting several hours',
      problemCategory: 'Health',
      solution: 'Tried all common home remedies',
      result: 'Hiccups continued regardless of method',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.0,
      totalRatings: 133,
    ...
    {
      id: 429,
      problem: 'Friend constantly one-upping my stories',
      problemCategory: 'Relationship',
      solution: 'Started exaggerating own stories to compete',
      result: 'Friendship became inauthentic and competitive',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.4,
      totalRatings: 172,
    ...
    {
      id: 430,
      problem: 'Chronic sinus pressure and congestion',
      problemCategory: 'Health',
      solution: 'Took decongestant medication daily',
      result: 'Pressure unchanged despite regular use',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 146,
    ...
    {
      id: 431,
      problem: 'Roommate leaving messes in shared spaces',
      problemCategory: 'Relationship',
      solution: 'Stopped cleaning to teach them lesson',
      result: 'Apartment became filthy, both living in mess',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 183,
    ...
    },
    {
      ...
      problem: 'Chronic bad breath despite dental hygiene',
      problemCategory: 'Health',
      solution: 'Tried different mouthwashes and products',
      result: 'Odor persisted with all products',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 152,
    ...
    {
      id: 433,
      problem: 'Child struggling with virtual school focus',
      problemCategory: 'Education',
      solution: 'Threatened punishment for not paying attention',
      result: 'Child developed anxiety, focus worsened',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
      totalRatings: 194,
    ...
    {
      id: 434,
      problem: 'Muscle cramps in calves during sleep',
      problemCategory: 'Health',
      solution: 'Increased potassium through diet',
      result: 'Cramps occurred at same frequency',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
    ...
    {
      id: 435,
      problem: 'Partner spending too much on shopping',
      problemCategory: 'Finance',
      solution: 'Hid credit cards and confronted angrily',
      result: 'Partner opened secret accounts, spending increased',
      resultCategory: 'got-worse',
    ...
    {
      id: 436,
      problem: 'Morning joint stiffness lasting over hour',
      problemCategory: 'Health',
      solution: 'Tried glucosamine supplements',
      result: 'Stiffness unchanged after months',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 148,
    ...
    {
      id: 437,
      problem: 'Adult son unemployed living at home',
      problemCategory: 'Family',
      solution: 'Continued providing everything without conditions',
      result: 'Son more dependent, no job search effort',
      resultCategory: 'got-worse',
      author: '',
      age: '41-60',
      avgRating: 4.7,
    ...
    {
      id: 438,
      problem: 'Dry eyes causing discomfort all day',
      problemCategory: 'Health',
      solution: 'Used artificial tears eye drops',
      result: 'Temporary relief only, symptoms persisted',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 164,
    ...
    },
    {
      ...
      problem: 'Teenager coming home drunk on weekends',
      problemCategory: 'Family',
      solution: 'Grounded for months and removed car',
      result: 'Teen became secretive, drinking increased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.4,
      totalRatings: 177,
    ...
    {
      id: 440,
      problem: 'Constipation lasting over week',
      problemCategory: 'Health',
      solution: 'Increased fiber through diet',
      result: 'Constipation unchanged despite changes',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 153,
    ...
    {
      id: 441,
      problem: 'Spouse forgetting important dates',
      problemCategory: 'Relationship',
      solution: 'Used silent treatment as punishment',
      result: 'Communication broke down, distance increased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
      totalRatings: 189,
    ...
    {
      id: 442,
      problem: 'Frequent nosebleeds during winter',
      problemCategory: 'Health',
      solution: 'Applied petroleum jelly inside nose',
      result: 'Nosebleeds continued at same rate',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.0,
      totalRatings: 137,
    ...
    {
      id: 443,
      problem: 'Daughter failing math despite tutoring',
      problemCategory: 'Education',
      solution: 'Doubled tutoring hours and added pressure',
      result: 'Daughter developed anxiety and depression',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 197,
    ...
    {
      id: 444,
      problem: 'Weight loss plateau despite diet',
      problemCategory: 'Health',
      solution: 'Tried various diet supplements',
      result: 'Weight remained unchanged',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 161,
    ...
    {
      id: 445,
      problem: 'Partner dismissive when sharing feelings',
      problemCategory: 'Relationship',
      solution: 'Stopped sharing to avoid rejection',
      result: 'Emotional intimacy died completely',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.8,
      totalRatings: 208,
