...
export default function LearnFromMe() {
  ...
  const [experiences, setExperiences] = useState([
    ...
    {
      id: 346,
      problem: 'Persistent bad breath ruining confidence in social situations',
      problemCategory: 'Health',
      solution: 'Dentist found and removed hidden tonsil stones causing odor',
      result: 'Breath fresh permanently, social confidence fully restored',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 176,
    ...
    {
      id: 347,
      problem: 'Car check engine light on for three months',
      problemCategory: 'Other',
      solution: 'Bought OBD2 scanner, diagnosed loose gas cap',
      result: 'Light cleared immediately, saved diagnostic fees',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 142,
    ...
    {
      id: 348,
      problem: 'Child bed-wetting at age 8 causing shame',
      problemCategory: 'Family',
      solution: 'Pediatrician recommended bedwetting alarm system',
      result: 'Dry nights within 6 weeks, child confident',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 203,
    ...
    },
    {
      ...
      problemCategory: 'Well-being',
      solution: 'Started cognitive behavioral therapy with exposure practice',
      result: 'Successfully interviewed, got job, anxiety manageable',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 350,
      problem: 'Washing machine flooding laundry room',
      problemCategory: 'Other',
      solution: 'Replaced worn rubber door seal gasket',
      result: 'No more leaks, machine perfect',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 156,
    ...
    {
      id: 351,
      problem: 'Credit score stuck at 620 despite payments',
      problemCategory: 'Finance',
      solution: 'Paid collections, became authorized user on good account',
      result: 'Score increased to 720 in 8 months',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 194,
    ...
    },
    {
      ...
      result: 'Behavior stopped within 2 weeks',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 138,
    ...
    {
      id: 353,
      problem: 'Severe menstrual cramps debilitating monthly',
      problemCategory: 'Health',
      solution: 'Gynecologist prescribed birth control for symptom management',
      result: 'Pain reduced 90%, quality of life improved',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 354,
      problem: 'Teen daughter self-harming, cuts on arms',
      problemCategory: 'Family',
      solution: 'Got immediate mental health evaluation and therapy',
      result: 'Self-harm stopped, depression being treated',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 224,
    ...
    {
      id: 355,
      problem: 'Chronic shoulder pain limiting movement',
      problemCategory: 'Health',
    ...
    {
      id: 356,
      problem: 'Infant reflux causing constant spit-up',
      problemCategory: 'Family',
      solution: 'Pediatrician suggested smaller frequent feedings, keep upright',
      result: 'Reflux dramatically reduced, baby comfortable',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 357,
      problem: 'Laptop overheating and fan loud',
      problemCategory: 'Other',
      solution: 'Opened case, cleaned dust from vents',
      result: 'Quiet operation, temperature normal',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 159,
    ...
    {
      id: 358,
      problem: 'Credit card interest charges accumulating',
      problemCategory: 'Finance',
      solution: 'Called card company, negotiated lower APR',
    ...
    {
      id: 359,
      problem: 'Eyebrow hair loss creating bald patches',
      problemCategory: 'Health',
    ...
    {
      id: 360,
      problem: 'Performance reviews consistently mediocre',
      problemCategory: 'Work',
      solution: 'Asked for specific feedback, created improvement plan',
    ...
    {
      id: 361,
      problem: 'Toddler tantrums increasing in intensity',
      problemCategory: 'Family',
    ...
    {
      id: 362,
      problem: 'Chronic sinusitis causing facial pain',
      problemCategory: 'Health',
      solution: 'ENT prescribed antibiotic course, daily sinus rinse',
      result: 'Infection cleared, no recurrence in year',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 182,
    ...
    {
      id: 363,
      problem: 'Wedding debt overwhelming newlyweds',
      problemCategory: 'Finance',
      solution: 'Created strict budget, both got second jobs temporarily',
      result: 'Debt paid in 18 months, marriage stronger',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 169,
    ...
    {
      id: 364,
      problem: 'Vitamin D deficiency causing fatigue',
      problemCategory: 'Health',
      solution: 'Doctor prescribed supplement, increased sun exposure',
      result: 'Energy returned, mood improved significantly',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '21-40',
    ...
    {
      id: 365,
      problem: 'Deck boards rotting and unsafe',
      problemCategory: 'Other',
      solution: 'Replaced damaged boards with composite decking',
      result: 'Deck safe and maintenance-free',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 157,
    ...
    {
      id: 366,
      problem: 'Child terrified of water, refusing swimming',
      problemCategory: 'Family',
      solution: 'Found instructor specializing in anxious children',
      result: 'Child now loves swimming, fear overcome',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 206,
    ...
    {
      id: 367,
      problem: 'Basement flooding during heavy rain',
      problemCategory: 'Other',
      solution: 'Installed French drain and sump pump',
      result: 'Basement dry even in worst storms',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 213,
    ...
    {
      id: 368,
      problem: 'Recurring UTIs every month',
      problemCategory: 'Health',
      solution: 'Urologist found anatomical issue, performed surgery',
    ...
    {
      id: 369,
      problem: 'Teenager refusing all household chores',
      problemCategory: 'Family',
      solution: 'Implemented allowance tied to completed tasks',
      result: 'Teen completing chores to earn money',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.5,
      totalRatings: 132,
    ...
    {
      id: 370,
      problem: 'Excessive sweating causing embarrassment',
      problemCategory: 'Health',
      solution: 'Dermatologist prescribed clinical strength antiperspirant',
      result: 'Sweating reduced 80%, confidence restored',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 371,
      problem: 'Investment portfolio underperforming market',
      problemCategory: 'Finance',
      solution: 'Hired fee-only advisor, rebalanced allocation',
      result: 'Returns improved, now beating market',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 153,
    ...
    {
      id: 372,
      problem: 'Dog barking aggressively at mail carrier',
      problemCategory: 'Other',
      solution: 'Worked with trainer on desensitization protocol',
      result: 'Dog calm during mail delivery',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.7,
      totalRatings: 166,
    ...
    {
      id: 373,
      problem: 'Gum recession exposing tooth roots',
      problemCategory: 'Health',
      solution: 'Periodontist performed gum graft procedure',
      result: 'Gums healthy, sensitivity eliminated',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '41-60',
    ...
    {
      id: 374,
      problem: 'Passed over for promotion three times',
      problemCategory: 'Work',
      solution: 'Had honest conversation with boss about career',
      result: 'Given clear promotion timeline and goals',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 142,
    ...
    {
      id: 375,
      problem: 'Baby not sleeping through night at one year',
      problemCategory: 'Family',
      solution: 'Implemented sleep training method consistently',
      result: 'Baby sleeping 11 hours nightly within week',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 197,
    ...
    {
      id: 376,
      problem: 'Knee swelling after exercise',
      problemCategory: 'Health',
      solution: 'Orthopedist prescribed strengthening exercises',
      result: 'Swelling resolved, knee stable',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 377,
      problem: 'Scalp psoriasis causing flaking',
      problemCategory: 'Health',
      solution: 'Dermatologist prescribed medicated shampoo and cream',
      result: 'Scalp clear, no more flaking',
      resultCategory: 'worked',
      author: '',
      gender: 'Male',
      age: '21-40',
    ...
    {
      id: 378,
      problem: 'Child struggling with reading comprehension',
      problemCategory: 'Education',
      solution: 'Evaluation revealed dyslexia, accommodations provided',
      result: 'Reading improving, confidence growing',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.9,
      totalRatings: 208,
    ...
    {
      id: 379,
      problem: 'Morning anxiety attacks before work',
      problemCategory: 'Well-being',
      solution: 'Therapist taught grounding techniques, started medication',
      result: 'Attacks rare, mornings peaceful',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.8,
      totalRatings: 186,
    ...
    {
      id: 380,
      problem: 'Chronic constipation despite fiber',
      problemCategory: 'Health',
      solution: 'Gastroenterologist diagnosed pelvic floor dysfunction, specialist treatment',
      result: 'Bowel movements regular, quality improved',
      resultCategory: 'worked',
      author: '',
      gender: 'Female',
      age: '41-60',
    ...
    {
      id: 381,
      problem: 'Teen wants to drop out of college',
      problemCategory: 'Education',
      solution: 'Non-judgmental conversation about reasons and alternatives',
      result: 'Teen took semester off, returned motivated',
      resultCategory: 'worked',
      author: '',
      avgRating: 4.6,
      totalRatings: 149,
    ...
    },
    {
      ...
      problemCategory: 'Health',
      solution: 'Tried sound therapy and white noise',
      result: 'Tinnitus volume unchanged, still bothersome',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 163,
    ...
    {
      id: 383,
      problem: 'Lower back pain from office chair',
      problemCategory: 'Health',
      solution: 'Tried various lumbar support cushions',
      result: 'Pain persisted at same level',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 148,
    ...
    },
    {
      ...
      problemCategory: 'Relationship',
      solution: 'Made passive-aggressive comments about phone',
      result: 'Spouse defensive, phone use unchanged, tension increased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 177,
    ...
    {
      id: 385,
      problem: 'Dandruff despite specialized shampoos',
      problemCategory: 'Health',
      solution: 'Tried five different shampoo brands',
    ...
    {
      id: 386,
      problem: 'Teen lying about whereabouts',
      problemCategory: 'Family',
      solution: 'Installed tracking software secretly',
    ...
    {
      id: 387,
      problem: 'Persistent dry cough for weeks',
      problemCategory: 'Health',
      solution: 'Took over-the-counter suppressants',
      result: 'Cough unchanged despite medication',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 142,
    ...
    {
      id: 388,
      problem: 'Child refusing healthy foods',
      problemCategory: 'Family',
      solution: 'Only provided junk food to avoid conflict',
      result: 'Child more selective, diet worse',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.4,
      totalRatings: 184,
    ...
    {
      id: 389,
      problem: 'Chronic heartburn after meals',
      problemCategory: 'Health',
      solution: 'Eliminated acidic foods from diet',
      result: 'Heartburn at same frequency',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 167,
    ...
    {
      id: 390,
      problem: 'Partner critical of everything',
      problemCategory: 'Relationship',
      solution: 'Started criticizing them equally',
      result: 'Criticism escalated, relationship toxic',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 198,
    ...
    },
    {
      ...
      problemCategory: 'Health',
      solution: 'Tried magnesium supplements',
    ...
    {
      id: 392,
      problem: 'Friend constantly canceling plans',
      problemCategory: 'Relationship',
      solution: 'Confronted them aggressively',
    ...
    {
      id: 393,
      problem: 'Afternoon headaches at work',
      problemCategory: 'Health',
      solution: 'Increased caffeine and water',
      result: 'Headaches unchanged',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.2,
      totalRatings: 158,
    ...
    {
      id: 394,
      problem: 'Teenager withdrawn and isolating',
      problemCategory: 'Family',
      solution: 'Removed bedroom door as punishment',
      result: 'Teen more secretive and resentful',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.6,
      totalRatings: 187,
    ...
    {
      id: 395,
      problem: 'Dry skin despite moisturizer',
      problemCategory: 'Health',
      solution: 'Switched to luxury brand',
      result: 'Dryness unchanged with premium product',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 144,
    ...
    {
      id: 396,
      problem: 'Coworker taking credit for work',
      problemCategory: 'Work',
      solution: 'Sent angry email to department',
    ...
    {
      id: 397,
      problem: 'Chronic fatigue despite sleep',
      problemCategory: 'Health',
      solution: 'Tried energy supplement pills',
      result: 'Energy unchanged',
      resultCategory: 'no-change',
      author: '',
      avgRating: 4.1,
      totalRatings: 154,
    ...
    {
      id: 398,
      problem: 'Sibling borrowing money not repaying',
      problemCategory: 'Family',
      solution: 'Lent more hoping they would pay back',
      result: 'Owed even more, still no repayment',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.3,
      totalRatings: 171,
    ...
    },
    {
      ...
      problemCategory: 'Relationship',
      solution: 'Made comments about appearance',
      result: 'Partner hurt, intimacy decreased',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.7,
      totalRatings: 203,
    ...
    {
      id: 400,
      problem: 'Son failing multiple classes',
      problemCategory: 'Education',
      solution: 'Grounded indefinitely, removed privileges',
      result: 'Grades declined, depression developed',
      resultCategory: 'got-worse',
      author: '',
      avgRating: 4.5,
      totalRatings: 188,
